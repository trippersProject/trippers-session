<div class="col-md-9 ms-sm-auto col-lg-10 p-md-4">
    ...
    <form method="post" id="articleForm">
        ...
        <div>
            ...
            <h4>노출용 본문</h4>
                <input type="textarea" name="content_sub" id="content_sub" class="form-control" value="">
            <hr>
            ...
            <BR>
            <h4>이벤트배너 연결링크</h4>
                <input type="text" name="event_banner_link" id="event_banner_link" class="form-control">
            <hr>
