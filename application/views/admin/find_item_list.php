        ...
        <table class="table table-striped table-sm w100">
            ...
            <?php foreach ($list as $key => $value): ?>
                <tr>
                    ...
                    <td><?= $value['regdate']; ?></td>
                    <td>
                        <button onclick="location.href='find_item/modify?id=<?= $value['id']?>'" class="btn btn-primary btn-sm">수정</button>
                        <button onclick="deleteFinditem(<?= $value['id']?>)" class="btn btn-danger btn-sm">삭제</button>
                    </td>
                </tr>
            <?php endforeach; ?>
            <?php else: ?>
